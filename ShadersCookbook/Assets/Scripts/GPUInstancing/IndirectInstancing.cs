...
public class IndirectInstancing : MonoBehaviour
{
    ...
    [Range(1, 25000.0f)] public int instanceCount = 100000;
    ...
    void Update()
    {
        ...
        if (Input.GetAxisRaw("Horizontal") != 0.0f)
            instanceCount = (int)Mathf.Clamp(instanceCount + Input.GetAxis("Horizontal") * 40000, 1.0f, 25000.0f);
    ...
    void OnGUI()
    {
        ...
        instanceCount = (int)GUI.HorizontalSlider(new Rect(25, 20, 200, 30), (float)instanceCount, 1.0f, 25000.0f);
    }
